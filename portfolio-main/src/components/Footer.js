...
export default function Footer() {
    return (
        <section className="p-3 bg-blue-300 flex fixed bottom-0 w-full">
                ...
                <a href="https://github.com/bhawna1809" target="_blank"  rel="noreferrer" className="text-gray-800 mr-10 hover:text-black">
                <i className="fab fa-github fa-2x"></i>
            </a>
            <a href="https://www.linkedin.com/in/bhawna-tekwani" target="_blank"  rel="noreferrer" className="text-blue-900 hover:text-black">
